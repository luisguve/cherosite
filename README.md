...
1. [Explore page: "/explore"](#explore-page)
1. [Other users' profile page: "/profile?username={username}"](1. #other-users-profile-page)
1. [Section page: "/{section_id}"](#section-page)
1. [Post page: "/{section_id}/{post_id}"](#post-page)
